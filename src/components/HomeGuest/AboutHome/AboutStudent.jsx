      ...
      <div className="container mx-auto px-2">
        <div className=" py-7 px-3 flex md:justify-between items-center justify-center flex-wrap md:flex-nowrap">
          <div data-aos="fade-right" className="order-2 md:order-1">
            ...
            <div className="py-5">
              <button className="border-2  xl:text-[24px] md:text-[20px] font-[roboto] cursor-pointer transition ease-in-out duration-200 hover:bg-white hover:text-[#095544] border-[#095544] font-medium bg-[#095544] text-white py-1 px-4 rounded-lg">
                Join Now
              </button>
            </div>
          </div>

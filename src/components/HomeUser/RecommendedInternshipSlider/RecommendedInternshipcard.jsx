    ...
    <div>
      <div className="bg-white rounded-lg p-4 shadow-lg ">
        ...
        <div className="flex gap-2">
          <button className="bg-[#3A4C59] flex items-center font-semibold rounded-lg gap-2 opacity-85 text-white px-4 py-2">
            <span>
              <CiClock2 size={20} />
            </span>
            Full Time
        ...
        <div>
          <div className="my-4">
            <img
              ...
              alt="applicationUser"
            />
            <p className="text-[#3A4C59] font-[roboto] text-[13px] font-medium my-1">
              20 Application
            </p>
          </div>
          <div></div>
